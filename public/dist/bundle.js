...
var message_1 = __webpack_require__(121);
...
socket.on('message to client', function (message) {
    var msg = new message_1.Message(message);
...
socket.on('userList', function (users) {
    privateMessage_1.reloadPrivateMessagingList(users, username);
    var ul = $('#userList');
    ul.empty();
...
var Timer = /** @class */ (function () {
     ...
     */
    function Timer(ms, untilSec) {
        var _this = this;
        this.start = function (username) {
            if (_this.self === null) {
                _this.inputUsers.push(username);
                _this.until = _this.untilSec;
                _this.writeTypingListToStatusBar();
                _this.self = setInterval(function () {
                    _this.until--;
                    if (_this.until <= 0) {
                        _this.stop();
                    }
                ...
                if (_this.inputUsers.indexOf(username) < 0)
                    _this.inputUsers.push(username);
                _this.reset();
            }
        };
        this.stop = function () {
            clearInterval(_this.self);
            _this.self = null;
            _this.inputUsers = [];
            $('#statusBar').text("");
        };
    ...
    ;
    Timer.prototype.writeTypingListToStatusBar = function () {
        var users = this.inputUsers.join(', ');
...
Object.defineProperty(exports, "__esModule", { value: true });
var $ = __webpack_require__(1);
function reloadPrivateMessagingList(userList, currentUser) {
    var list = $('#messageTo');
    list.empty();
    list.append("<option id='toAll'>All</option>");
    Object.keys(userList)
        .filter(function (username) { return userList[username] && username != currentUser; })
        .forEach(function (username) {
        list.append("<option id=\"to" + username + "\">" + username + "</option>");
    });
}
exports.reloadPrivateMessagingList = reloadPrivateMessagingList;
